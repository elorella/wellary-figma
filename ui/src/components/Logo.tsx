...
export function Logo({ size = "md", showText = true }: LogoProps) {
  ...
  const sizes = {
    sm: {
      width: showText ? 80 : 24,
      height: showText ? 24 : 24,
      viewBox: showText ? "0 0 80 24" : "0 0 24 24",
      circleCx: showText ? 10 : 12,
      circleCy: showText ? 12 : 12,
      circleR: showText ? 8 : 10,
      pathD: showText 
    ...
    md: {
      width: showText ? 120 : 32,
      height: showText ? 32 : 32,
      viewBox: showText ? "0 0 120 32" : "0 0 32 32",
      circleCx: showText ? 12 : 16,
      circleCy: showText ? 16 : 16,
      circleR: showText ? 10 : 13,
      pathD: showText
    ...
    lg: {
      ...
      viewBox: showText ? "0 0 180 48" : "0 0 48 48",
      circleCx: showText ? 18 : 24,
      circleCy: showText ? 24 : 24,
      circleR: showText ? 15 : 20,
      pathD: showText
