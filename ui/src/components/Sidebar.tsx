          ...
          <div className="flex items-center">
            ...
            >
              ...
              <circle
                ...
                cy="16"
                r="10"
                fill="url(#wellary-gradient)"
              />
              <path
                d="M12 9 C12 9, 16 13, 16 16 C16 19, 12 23, 12 23 C12 23, 8 19, 8 16 C8 13, 12 9, 12 9"
                fill="white"
                fillOpacity="0.9"
              />
          ...
          <div className="mx-auto">
            ...
            >
              <circle
                ...
                cy="12"
                r="10"
                fill="url(#wellary-gradient-small)"
              />
              <path
                d="M12 7 C12 7, 15 10, 15 12 C15 14, 12 17, 12 17 C12 17, 9 14, 9 12 C9 10, 12 7, 12 7"
                fill="white"
                fillOpacity="0.9"
              />
              <defs>
                <linearGradient
                  id="wellary-gradient-small"
                  x1="2"
                  y1="2"
                  x2="22"
                  y2="22"
      ...
      <nav className="flex-1 p-2">
        <div className="space-y-1">
          ...
          <Button
            variant="ghost"
            onClick={() =>
              onPageChange && onPageChange("fruid-exchange")
            }
            className={`w-full rounded-xl hover:bg-gray-100 ${
              isCollapsed
                ? "justify-center px-2"
          ...
          <Button
            variant="ghost"
            onClick={() =>
              onPageChange && onPageChange("my-lists")
            }
            className={`w-full rounded-xl hover:bg-gray-100 ${
              isCollapsed
                ? "justify-center px-2"
                : "justify-start"
            } ${activePage === "my-lists" ? "bg-orange-50 text-orange-600 hover:bg-orange-100" : ""}`}
          >
            <List className="w-5 h-5" strokeWidth={2} />
            {!isCollapsed && (
              <span className="ml-3">Planlarim</span>
            )}
          </Button>
          ...
          >
            ...
            {!isCollapsed && (
              <span className="ml-3">Randevularim</span>
            )}
          </Button>
          ...
          <Button
            variant="ghost"
            onClick={() =>
              onPageChange && onPageChange("reach_out")
            }
            className={`w-full rounded-xl hover:bg-gray-100 ${
              isCollapsed
                ? "justify-center px-2"
          ...
          <Button
            variant="ghost"
            onClick={() =>
              onPageChange && onPageChange("payment_history")
            }
            className={`w-full rounded-xl hover:bg-gray-100 ${
              isCollapsed
                ? "justify-center px-2"
          ...
          >
            ...
            {!isCollapsed && (
              <span className="ml-3">Odeme Planim</span>
            )}
          </Button>
        </div>
      </nav>
